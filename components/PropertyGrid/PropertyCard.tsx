...
export default function PropertyCard({ property, searchParams }: PropertyCardProps) {
  ...
  return (
    <div className="bg-white rounded-xl overflow-hidden border border-slate-200 hover:border-slate-300 hover:shadow-xl shadow-md transition-all duration-300 group flex flex-col">
      ...
      <Link href={detailUrl} className="relative block overflow-hidden" style={{ aspectRatio: '4/3' }}>
        ...
        <button
          ...
          className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm p-2 rounded-full shadow hover:bg-white transition-colors z-10"
          aria-label="Save property"
        >
          <svg className="w-4 h-4 text-slate-400 hover:text-red-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {property.images.length > 1 && (
          <div className="absolute bottom-3 right-3 flex items-center gap-1 bg-black/55 text-white text-xs px-2.5 py-1 rounded-full backdrop-blur-sm">
        ...
        <div className="flex items-center gap-4 text-sm text-slate-600 mb-3">
          <span className="flex items-center gap-1.5">
            ...
            <svg className="w-4 h-4 text-slate-400" fill="currentColor" viewBox="0 0 24 24">
              <path d="M2 10V7a1 1 0 011-1h18a1 1 0 011 1v3h-1V7H3v3H2zm0 0h1v7H2v-7zm19 0h1v7h-1v-7zM1 17h22v2H1v-2zM3 10h18v5H3v-5zm3-4a3 3 0 100-6 3 3 0 000 6z" />
            </svg>
