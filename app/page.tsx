      ...
      <section style={{
        ...
        <div style={{ maxWidth: '720px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{
            ...
            Planning a group trip? Book all three apartments for up to 21&nbsp;guests.
            Or just ask us anything about Cascade Apartments.
          </p>
          ...
          <p style={{
            ...
            Select &ldquo;Group Booking&rdquo; below for group-specific options
          </p>
        </div>
